...
type NotificationHandlers struct {
	...
	OnWinningTickets func(blockHash *chainhash.Hash,
		blockHeight int64, blockKeyHeight int64,
...
func (c *Client) handleNotification(ntfn *rawNotification) {
	...
	case dcrjson.WinningTicketsNtfnMethod:
		...
		blockHash, blockHeight, blockKeyHeight, tickets, err :=
...
func parseWinningTicketsNtfnParams(params []json.RawMessage) (
	*chainhash.Hash,
	...
	var blockKeyHeight int32
	err = json.Unmarshal(params[2], &blockKeyHeight)
	if err != nil {
		return nil, 0, 0, nil, err
	}
	bKeyHeight := int64(blockKeyHeight)
	...
	return bHash, bHeight, bKeyHeight, t, nil
}
